...
anime game art style. It must get down on all fours on the ground,
it must have only one head and its fur must be distinguishable.
...
top-down game view optimized, fantasy creature, T-pose for rigging,
